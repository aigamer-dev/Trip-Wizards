...
import 'package:travel_wizards/src/services/booking_integration_service.dart';
import 'package:travel_wizards/src/services/booking_integration_models.dart';
...
class _EnhancedBookingsScreenState extends State<EnhancedBookingsScreen>
  ...
  Widget _buildActiveBookingsTab() {
    return StreamBuilder<List<BookingDetails>>(
      stream: context.read<BookingIntegrationService>().streamUserBookings(
