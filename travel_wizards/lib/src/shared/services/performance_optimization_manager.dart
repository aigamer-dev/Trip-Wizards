...
import 'package:travel_wizards/src/shared/services/performance_service.dart';
import 'package:travel_wizards/src/shared/services/widget_cache_service.dart';
import 'package:travel_wizards/src/shared/services/asset_optimization_service.dart';
import 'package:travel_wizards/src/shared/widgets/performance/performance_monitor.dart'
    as pm;
...
class _PerformanceOptimizedAppState extends State<PerformanceOptimizedApp> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.enableMonitoring) {
      content = pm.PerformanceMonitor(showOverlay: kDebugMode, child: content);
    }
